...
const normalizeClientFilesHook = (hook) => async (app) => {
    ...
    const clientFilesResult = shared_1.isFunction(hook) ? await hook(app) : hook;
    const clientFiles = shared_1.isArray(clientFilesResult)
        ? clientFilesResult
        : [clientFilesResult];
...
//# sourceMappingURL=normalizeClientFilesHook.js.map