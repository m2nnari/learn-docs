...
exports.prepareClientAppSetups = void 0;
/**
 * Generate client app setups temp file
 */
const prepareClientAppSetups = async (app) => {
    // plugin hook: clientAppSetupFiles
    const clientAppSetupFiles = await app.pluginApi.hooks.clientAppSetupFiles.process(app);
...
exports.prepareClientAppSetups = prepareClientAppSetups;
//# sourceMappingURL=prepareClientAppSetups.js.map