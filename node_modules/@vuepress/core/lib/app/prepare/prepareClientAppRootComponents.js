...
exports.prepareClientAppRootComponents = void 0;
/**
 * Generate client app root components temp file
 */
const prepareClientAppRootComponents = async (app) => {
    // plugin hook: clientAppRootComponentFiles
    const clientAppRootComponentFiles = await app.pluginApi.hooks.clientAppRootComponentFiles.process(app);
    ...
    const content = `\
${filePaths
        .map((filePath, index) => `import clientAppRootComponent${index} from '${filePath}'`)
        .join('\n')}
...
exports.prepareClientAppRootComponents = prepareClientAppRootComponents;
//# sourceMappingURL=prepareClientAppRootComponents.js.map