...
const resolvePageRoutesInfo_1 = require("./resolvePageRoutesInfo");
...
const createPage = async (app, options) => {
    ...
    const excerpt = resolvePageExcerpt_1.resolvePageExcerpt({ excerptRaw, app, filePathRelative });
    ...
    const { headers, links, componentFilePath, componentFilePathRelative, componentFileContent, componentFileChunkName, } = await resolvePageComponentInfo_1.resolvePageComponentInfo({
        app,
        content,
        filePathRelative,
        path,
    ...
    const { dataFilePath, dataFilePathRelative, dataFileChunkName, } = resolvePageDataInfo_1.resolvePageDataInfo({ app, key });
    const { routesFilePath, routesFilePathRelative } = resolvePageRoutesInfo_1.resolvePageRoutesInfo({
        app,
        key,
    });
