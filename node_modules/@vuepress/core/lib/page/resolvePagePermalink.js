...
const resolvePagePermalink = ({ frontmatter, slug, date, pathInferred, pathLocale, }) => {
    ...
    if (shared_1.isString(frontmatter.permalink)) {
        return frontmatter.permalink;
    }
    // get permalink pattern from frontmatter or options
    const pattern = shared_1.isString(frontmatter.permalinkPattern)
    ...
    return shared_1.ensureLeadingSlash(link);
};
exports.resolvePagePermalink = resolvePagePermalink;
//# sourceMappingURL=resolvePagePermalink.js.map