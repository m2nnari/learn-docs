...
const inferPagePath = ({ app, filePathRelative, }) => {
    ...
    const pathInferred = shared_1.ensureLeadingSlash(filePathRelative)
        .replace(/\.md$/, '.html')
        .replace(/\/(README|index).html$/i, '/');
    // resolve page locale path
    const pathLocale = shared_1.resolveLocalePath(app.siteData.locales, pathInferred);
    return {
        pathInferred,
        pathLocale,
    };
...
//# sourceMappingURL=inferPagePath.js.map