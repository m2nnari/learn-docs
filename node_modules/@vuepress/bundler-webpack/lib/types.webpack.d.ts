...
export interface StatsToJsonOutput {
    ...
    builtAt?: number;
    children?: Array<StatsToJsonOutput & {
        name?: string;
    }>;
    chunks?: Array<{
        children: number[];
...
export declare type LoaderCallback = (err: Error | undefined | null, content?: string | Buffer, sourceMap?: RawSourceMap) => void;
...
//# sourceMappingURL=types.webpack.d.ts.map