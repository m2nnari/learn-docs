...
const createBaseConfig = ({ app, options, isServer, isBuild, }) => {
     ...
     * resolve
     */
    handleResolve_1.handleResolve({ app, config });
    /**
     * module
     */
     ...
     * plugins
     */
    handlePluginDefine_1.handlePluginDefine({ app, config, isServer });
    /**
     * other options
     */
...
//# sourceMappingURL=createBaseConfig.js.map