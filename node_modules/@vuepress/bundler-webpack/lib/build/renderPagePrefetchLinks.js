...
exports.renderPagePrefetchLinks = void 0;
/**
 * Render prefetch links of current page
 */
const renderPagePrefetchLinks = ({ app, asyncFilesMeta, pageClientFilesMeta, }) => {
    ...
    const prefetchFilesMeta = asyncFilesMeta.filter(({ file }) => !pageClientFilesMeta.some((f) => f.file === file));
...
exports.renderPagePrefetchLinks = renderPagePrefetchLinks;
//# sourceMappingURL=renderPagePrefetchLinks.js.map