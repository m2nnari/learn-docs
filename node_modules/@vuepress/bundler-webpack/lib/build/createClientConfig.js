...
const createClientConfig = (app, options) => {
    const config = config_1.createClientBaseConfig({
        app,
        options,
        isBuild: true,
    });
    ...
    config
        ...
        .use(ssr_1.createClientPlugin(app.dir.dest(exports.clientManifestFilename)));
