...
const tocPlugin_1 = require("./plugins/tocPlugin/tocPlugin");
const plugins_1 = require("./plugins");
const utils_1 = require("./utils");
/**
 * Create vuepress customized markdown-it instance
 */
const createMarkdown = ({ anchor, assets, code, customComponent, emoji, extractHeaders, hoistTags, links, toc, ...markdownItOptions } = {}) => {
