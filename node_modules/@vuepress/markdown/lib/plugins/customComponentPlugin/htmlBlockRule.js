...
exports.htmlBlockRule = void 0;
const blockNames = require("markdown-it/lib/common/html_blocks");
const htmlRe_1 = require("./htmlRe");
const inlineTags_1 = require("./inlineTags");
const vueReservedTags_1 = require("./vueReservedTags");
...
const htmlBlockRule = (state, startLine, endLine, silent) => {
    let i;
    let nextLine;
    let lineText;
...
//# sourceMappingURL=htmlBlockRule.js.map